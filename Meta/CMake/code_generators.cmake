...
function(generate_clang_module_map target_name)
    ...
    add_dependencies(imooglebrowser_codegen_accumulator "generate_${target_name}_module_map")
...
function(compile_ipc source output)
    ...
    add_dependencies(imooglebrowser_codegen_accumulator generate_${output_name})
