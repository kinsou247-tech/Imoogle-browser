...
import org.serenityos.imooglebrowser.databinding.ActivityMainBinding
...
class ImoogleBrowserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!testFile.exists())
        {
            ZipFile("$resourceDir/imooglebrowser-assets.zip").use { zip ->
        ...
        initNativeCode(resourceDir, "ImoogleBrowser", timerService, userDir)
        ...
        view.loadURL(intent.dataString ?: "https://google.com")
    }
    ...
    companion object {
        // Used to load the 'imooglebrowser' library on application startup.
        init {
            System.loadLibrary("ImoogleBrowser")
        }
    }
}
