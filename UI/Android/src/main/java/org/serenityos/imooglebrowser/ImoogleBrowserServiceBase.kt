...
abstract class ImoogleBrowserServiceBase(protected val TAG: String) : Service() {
    ...
    companion object {
        ...
        class IncomingHandler(private val service: WeakReference<ImoogleBrowserServiceBase>) :
