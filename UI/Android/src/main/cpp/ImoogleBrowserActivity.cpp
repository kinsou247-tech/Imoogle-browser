...
Java_org_serenityos_imooglebrowser_ImoogleBrowserActivity_initNativeCode(JNIEnv*, jobject, jstring, jstring, jobject, jstring);

extern "C" JNIEXPORT void JNICALL
Java_org_serenityos_imooglebrowser_ImoogleBrowserActivity_initNativeCode(JNIEnv* env, jobject thiz, jstring resource_dir, jstring tag_name, jobject timer_service, jstring user_dir)
{
    char const* raw_resource_dir = env->GetStringUTFChars(resource_dir, nullptr);
    WebView::s_imooglebrowser_resource_root = raw_resource_dir;
    ...
    dbgln("Set resource dir to {}", WebView::s_imooglebrowser_resource_root);

    auto file_or_error = Core::System::open(MUST(String::formatted("{}/res/icons/48x48/app-browser.png", WebView::s_imooglebrowser_resource_root)), O_RDONLY);
    ...
    auto* event_loop_manager = new ImoogleBrowser::ALooperEventLoopManager(timer_service_ref);
    event_loop_manager->on_did_post_event = [] {
        ImoogleBrowser::JavaEnvironment env(global_vm);
    ...
    Main::Arguments arguments = {
        .argc = 0,
        .argv = nullptr,
        .strings = Span<StringView> { new StringView("imooglebrowser"sv), 1 }
    };
...
extern "C" JNIEXPORT void JNICALL
Java_org_serenityos_imooglebrowser_ImoogleBrowserActivity_execMainEventLoop(JNIEnv*, jobject /* thiz */);
...
extern "C" JNIEXPORT void JNICALL
Java_org_serenityos_imooglebrowser_ImoogleBrowserActivity_disposeNativeCode(JNIEnv*, jobject /* thiz */);

extern "C" JNIEXPORT void JNICALL
Java_org_serenityos_imooglebrowser_ImoogleBrowserActivity_disposeNativeCode(JNIEnv* env, jobject /* thiz */)
{
