...
void ViewImplementation::handle_web_content_process_crash(LoadErrorPage load_error_page)
{
    ...
    dbgln("Consider raising an issue at https://github.com/ImoogleBrowserBrowser/imooglebrowser/issues/new/choose");
    ...
    if (load_error_page == LoadErrorPage::Yes) {
        ...
        builder.append("<h1>ImoogleBrowser flew off-course!</h1>"sv);
